<div class="w3-bar w3-white w3-border-bottom center">
	<span class="w3-bar-item w3-large center flex-1 center">
		<svg
			stroke="currentColor"
			fill="none"
			stroke-width="2"
		...
		<span class="w3-margin-left logo">Svelte UI</span>
	</span>
	<a
		href="https://github.com/kvraamkey/svelte-ui"
		target="_blank"
		class="w3-bar-item w3-hover-opacity w3-right center"
	>
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
